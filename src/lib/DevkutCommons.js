...
import logo from '../Assets/Images/devkutLogo.png';
...
// Menu
// ================================================================================================================
export function DevkutMenu({ githubUser }) {
  const [isMenuOpen, setMenuState] = React.useState(false);
  return (
    <DevkutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        {/* <DevkutMenu.Logo src={logo} /> */}
        <h2 style={{ color: 'orange', opacity: '0.85' }}>
          DevKut
        </h2>
      ...
      {/* <DevkutMenuProfileSidebar githubUser={githubUser} /> */}
    </DevkutMenu.Wrapper>
  )
}
DevkutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: #308BC5;
  .devkutMenuProfileSidebar {
    background: white;
    position: fixed;
    z-index: 100;
    padding: 46px;
...
function DevkutMenuProfileSidebar({ githubUser }) {
  return (
...
// ================================================================================================================
export function DevkutProfileSidebarMenuDefault() {
  return (
    <DevkutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
...
DevkutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
